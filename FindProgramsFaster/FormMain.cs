// FormMain.cs - main user-interface for FindProgramsFaster 
// program
//
...
namespace FindPrograms
{
   ...
   public class FormMain : System.Windows.Forms.Form
   {
      ...
      private const string m_strAppName = "FindProgramsFaster";
      ...
      public FormMain()
      {
         ...
         //
         sbarMain.Text = "Ready";
         Trace.WriteLine("FindProgramsFaster: Starting...\r\n");
      ...
      private void InitializeComponent()
      {
         ...
         this.Name = "FormMain";
         this.Text = "RAPI - FindProgramsFaster";
      ...
      cmdAbout_Click(object sender, System.EventArgs e)
      {
         MessageBox.Show("(c) Copyright 2002-2004 " +
            ...
            "FindProgramsFaster - RAPI Sample for \n" +
