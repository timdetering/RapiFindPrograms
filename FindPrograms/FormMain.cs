// FormMain.cs - main user-interface for FindPrograms program
//
...
namespace FindPrograms
{
   ...
   public class FormMain : System.Windows.Forms.Form
   {
      ...
      private const string m_strAppName = "FindPrograms";
      ...
      public FormMain()
      {
         ...
         //
         sbarMain.Text = "Ready";
         Trace.WriteLine("FindPrograms: Starting...\r\n");
      ...
      private void 
      FormMain_Closed(object sender, System.EventArgs e)
      {
